package kolokvijumi.kol1_v_z02_p02;
...
public class Gadjanje extends InfoTip {
	...
	public InfoTip ucitaj(SvetovidReader read) {
		...
		Gadjanje rez = new Gadjanje(read.readInt());
		
		for (int i = 0; i < rez.rezultati.length; i++)
			rez.rezultati[i] = read.readInt();
